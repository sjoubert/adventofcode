...
int main()
{
  ...
  auto validUniqueCount = std::count_if(DATA.begin(), DATA.end(), [](std::vector<std::string> const& p_passphrase)
  {
    auto passphrase = p_passphrase;
    std::sort(passphrase.begin(), passphrase.end());
    passphrase.erase(std::unique(passphrase.begin(), passphrase.end()), passphrase.end());
    return passphrase.size() == p_passphrase.size();
  });
  auto validAnagramCount = std::count_if(DATA.begin(), DATA.end(), [](std::vector<std::string> const& p_passphrase)
  {
    auto passphrase = p_passphrase;
